...
class WalletController
{
    ...
    public function deposit(int $walletId, array $body, ?string $idempotencyKey): void
    {
        $request = WalletAmountRequest::fromHttp($walletId, $body, $idempotencyKey);
        $result  = $this->service->deposit($request->walletId, $request->amountCents, $request->idempotencyKey);
